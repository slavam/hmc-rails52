Rails.application.routes.draw do
  ...
  get 'other_observations/post_precipitation', to: 'other_observations#post_precipitation'
  get 'other_observations/hydropost_precipitation', to: 'other_observations#hydropost_precipitation'
  get 'other_observations/monthly_precipitation_data', to: 'other_observations#monthly_precipitation_data'
  ...
  get 'synoptic_observations/teploenergo5_csdn', to: 'synoptic_observations#teploenergo5_csdn'
  ...
  get 'synoptic_observations/energy_1510_csdn', to: 'synoptic_observations#energy_1510_csdn'
  get 'synoptic_observations/amvrosievka_daily_avg_temp', to: 'synoptic_observations#amvrosievka_daily_avg_temp'
  get 'synoptic_observations/amvrosievka_daily_avg_temp_csdn', to: 'synoptic_observations#amvrosievka_daily_avg_temp_csdn'
  ...
  get 'bulletins/get_total_forecast', to: 'bulletins#get_total_forecast'
