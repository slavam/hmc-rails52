Rails.application.routes.draw do
  ...
  get 'other_observations/winds', to: 'other_observations#winds'
  ...
  get 'other_observations/total_monthly_precipitation', to: 'other_observations#total_monthly_precipitation'
  ...
  get 'agro_dec_observations/input_agro_dec_rf', to: 'agro_dec_observations#input_agro_dec_rf'
  post 'agro_dec_observations/create_agro_dec_rf', to: 'agro_dec_observations#create_agro_dec_rf'
  get 'agro_dec_observations/last_20_telegrams_rf', to: 'agro_dec_observations#last_20_telegrams_rf'
  ...
  post 'agro_observations/create_agro_rf', to: 'agro_observations#create_agro_rf'
  ...
  get 'synoptic_observations/teploenergo2', to: 'synoptic_observations#teploenergo2'
  get 'synoptic_observations/teploenergo5', to: 'synoptic_observations#teploenergo5'
  get 'synoptic_observations/temperatures_12local', to: 'synoptic_observations#temperatures_12local'
  ...
  get 'synoptic_observations/amvrosievka_daily_avg_temp', to: 'synoptic_observations#amvrosievka_daily_avg_temp'
