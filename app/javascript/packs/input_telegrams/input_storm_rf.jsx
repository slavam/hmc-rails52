...
export function InputStormRf({telegrams, stations, currStationId}){
  ...
  const tailPattern = (isStart,code)=>{
    switch (+code) {
      ...
      case 16:
      case 17:
        // setTail(isStart?'1ddffFF 2DDww=':'1ddffFF 2DDww 906tt=') 20230531 RAI
        setTail(isStart?'1ddffFF=':'1ddffFF 906tt=')
        break
      case 18:
      case 19:
        // setTail('1ddffFF 2DDww=') 20230531 RAI
        setTail('1ddffFF=')
        break
      case 21:
      ...
      case 26:
        ...
        break
      case 30:
        // setTail('2//ww 8NChh=') 20230531 RAI
        setTail('8NChh=')
        break
      case 31:
      ...
      case 40:
        ...
        // setTail('2//ww 7VVttt=') 20230531 RAI
        setTail('7VVttt=')
        break
      case 41:
      case 42:
  ...
  const saveStormMessage = ()=>{
    let maxDate = new Date().toISOString().replace('T',' ').slice(0,-8)
    let eventDate = dtlEventDate.replace('T',' ').slice(0,-4)
    if(eventDate>maxDate){
      alert(`Дата/время явления ${eventDate} больше текущих ${maxDate}`)
      return
    }
    let error = []
