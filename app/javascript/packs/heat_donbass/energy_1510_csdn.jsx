...
export default class Energy2CSDN extends React.Component{
  constructor(props){
    super(props);
  ...
  handleFormSubmit(year, month){
    ...
    $.ajax({
      type: 'GET',
      dataType: 'json',
      url: "/synoptic_observations/energy_1510_csdn?year="+year+"&month="+month
      }).done((data) => {
...
$(() => {
  ...
  if(node) {
    ...
    ReactDOM.render(
      <Energy2CSDN temperatures={temperatures} year={year} month={month} />,
