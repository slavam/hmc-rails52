...
export default class Energy2 extends React.Component{
  constructor(props){
    super(props);
  ...
  handleFormSubmit(year, month){
    ...
    $.ajax({
      type: 'GET',
      dataType: 'json',
      url: "/synoptic_observations/energy_1510?year="+year+"&month="+month
      }).done((data) => {
...
$(() => {
  ...
  if(node) {
    ...
    ReactDOM.render(
      <Energy2 temperatures={temperatures} year={year} month={month} />,
