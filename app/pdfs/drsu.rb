class Drsu < Prawn::Document
  ...
  def initialize(bulletin)
    ...
    bounding_box([0, y_pos], width: 300, leading: 3) do
      ...
      text "К договору от __________ № 32/23/02.01"
    end
    
    bounding_box([270, y_pos], width: bounds.width-270) do
      text "Начальнику
            МУП Администрации г. Донецка
            \"Дрожное ремонтно-строительное
            управление\"
		
            Скиданову С.С.", leading: 3
    end
    ...
    move_down 5
    text "в городе Донецке", align: :center
    move_down 10
